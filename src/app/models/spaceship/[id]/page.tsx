...
export default function Page() {
    ...
    return (
        <div className="flex flex-col items-center px-10">
            <h1 className="font-bold py-5 text-4xl">{ship.name}</h1>
            <Image className="rounded-lg mb-4" src={ship.imageUrl} height={200} width={400} alt={ship.name} />
            ...
            <p className="sm:text-center text-center py-6 text-sm">{ship.description}</p>
